...
<div align="center">
<img src="assets/pipeline-v2.svg" width="100%" alt="EXPLAIN ANALYZE how_i_ship: raw_data → azure_blob → data_factory → postgresql star schema → power_bi + ml → decisions, with quality gates: grain checks, null audits, dedup, reconcile to source, artifact-vs-signal test"/>
</div>
